...
![](https://github.com/statOmics/sbc20/raw/master/theory/figures/covidVegetables6.png){width=70%}

Nog niet gepubliceerd maar intussen ook geciteerd in 4 gepubliceerde wetenschappelijke artikels

---

![](https://github.com/statOmics/sbc20/raw/master/theory/figures/covidVegetables.png){width=70%}
...
![](https://github.com/statOmics/sbc20/raw/master/theory/figures/covidVegetables2.png){width=70%}
...
- Papers zijn nog niet aanvaard in een journal maar worden toch al 4 keer geciteerd in papers die reeds zijn gepubliceerd in wetenschappelijke tijdschriften!!!

---

Drie grote takken in statistiek

1. Statistische inferentie

  - Is er een verband tussen COVID-19 en voedselconsumptie?
...
- Dit wordt in de onderstaande code geïllustreerd. We trekken 1000 herhaalde steekproeven van 5 vrouwen en 5 mannen uit de NHANES studie.
...
Op basis van 1000 steekproeven van 5 mannen en 5 vrouwen zagen we dat in `r sum(res$pvalue<0.05&res$verschil<0)` steekproeven vrouwen gemiddeld significant kleiner zijn dan mannen. In `r sum(res$pvalue>=0.05)` steekproeven besluiten we dat vrouwen en mannen gemiddeld niet significant verschillen in lengte. En in `r sum(res$pvalue<0.05&res$verschil>0)` besluiten we dat vrouwen gemiddeld significant groter zijn dan mannen.
