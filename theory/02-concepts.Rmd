...
- Een event $A$  is een subset vam de steekproefruimte
...
Voor de kleine steekproef is de geschatte kans op basis van de empirische distributie veel minder nauwkeurig.
Kwantielen op basis van een kleine steekproef zijn immers vrij onzeker. Ze gebruiken immers maar een fractie van de data.   
De schatting op basis van de normale verdeling laat toe om alle data te gebruiken voor het schatten van de model parameters.
...
- Dit interval is een ruwe benadering. We hebben immers niet voldoende observaties om een goede benadering te hebben voor extreme quantielen.

### Normale benadering

- We kunnen de functie qnorm gebruiken om quantielen te berekenen van de normale distributie.

- We weten dat een 95% referentie interval ongeveer binnen de twee standaard deviaties rond het gemiddelde ligt.
